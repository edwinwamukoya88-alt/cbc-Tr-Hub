...
interface ReportCommentOutputProps {
  output?: string;
}

export function ReportCommentOutput({ output }: ReportCommentOutputProps) {
  ...
  const handleDownload = () => {
    ...
    a.href = url; a.download = "report-comment.md"; a.click();
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle>Generated Report Comment</CardTitle>
